        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden flex flex-col h-[calc(100vh-12rem)]">
              {/* Header */}
              <div className="bg-gradient-to-r from-primary-500 to-accent-500 text-white p-4 md:p-6 flex items-center justify-between">
                <div>
                  <h1 className="text-xl md:text-2xl font-display font-bold mb-1">
                    Community Chat
                  </h1>
                  <p className="text-white/80 text-xs md:text-sm flex items-center">
                    Connect with fellow food lovers •{' '}
                    {isConnected ? (
                      <span className="ml-2 flex items-center text-green-300">
                      ...
                      <span className="ml-2 flex items-center text-red-300">
                        <span className="relative flex h-2 w-2 mr-2">
                ...
                {!isConnected && (
                  <button
                    ...
                    className="px-3 py-2 md:px-4 md:py-2 bg-white text-primary-500 rounded-lg font-semibold hover:bg-gray-100 transition text-sm"
                  >
                    Retry
                  </button>
                )}
                    ...
                    >
                      <div className={`flex space-x-3 max-w-md ${isOwnMessage ? 'flex-row-reverse space-x-reverse' : ''}`}>
                        <Avatar 
                          ...
                          imageUrl={message.avatar || message.user?.avatar}
                          size="lg"
                        />
                        <div>
